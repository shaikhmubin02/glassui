...
description: A stylish button with an iridescent gradient effect and hover animation
component: true
links:
---
...
<ComponentPreview
  ...
  description="Iridescent Button Demo"
/>
...
<ComponentSource name="iridescent-button" />

<Step>Now copy and paste the following css styles into your project.</Step>
