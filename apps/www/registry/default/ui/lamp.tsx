  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-12 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-lg font-normal tracking-tight text-transparent md:text-5xl"
      >
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[500px] flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full rounded-md z-0',
        className
      )}
    >
