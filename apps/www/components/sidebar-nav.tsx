  ...
  if (item.href && !item.disabled) {
    return (
      ...
      >
        {item.title}
        {item.label && (
          <span className="ml-2 rounded-md bg-gradient-to-br from-purple-400 to-indigo-600 px-1.5 py-0.5 text-xs leading-none text-[#000000] no-underline group-hover:no-underline">
            {item.label}
          </span>
        )}
      </Link>
